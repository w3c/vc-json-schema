...
const credentialSchema = require("../../docs/example/cmtr/v0.1/cmtr-credential-schema-v0.1.json");
const credential = require("../../docs/example/cmtr/v0.1/cmtr-credential-v0.1.json");
...
describe("cmtr-v0.1", () => {
    describe("issue and verify verifiableCredentialSchema", () => {
        ...
        it("should pass when verifiableCredentialSchema is not mutated", async () => {
            ...
            fs.writeFileSync(path.resolve(__dirname, '../../docs/example/cmtr/v0.1/cmtr-verifiable-credential-schema-v0.1.json'), JSON.stringify(verifiableCredentialSchema, null, 2))
    ...
    describe("issue and verify verifiableCredential",  () => {
        ...
        it("should pass when verifiableCredential is not mutated ", async () => {
            ...
            fs.writeFileSync(path.resolve(__dirname, '../../docs/example/cmtr/v0.1/cmtr-verifiable-credential-v0.1.json'), JSON.stringify(verifiableCredential, null, 2))
